...
Generate content for section `section-04-jira` (filename: `section-04-jira.md`).
...
for `section-04-jira` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/02-integration-clients/sections/section-04-jira.md`
