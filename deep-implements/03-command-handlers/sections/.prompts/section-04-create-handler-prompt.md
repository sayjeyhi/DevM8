...
Generate content for section `section-04-create-handler` (filename: `section-04-create-handler.md`).
...
for `section-04-create-handler` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/03-command-handlers/sections/section-04-create-handler.md`
