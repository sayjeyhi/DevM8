...
Generate content for section `section-05-move-comment-help-handlers` (filename: `section-05-move-comment-help-handlers.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/03-command-handlers/claude-plan.md` - Full implementation plan
2. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/03-command-handlers/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/03-command-handlers/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-05-move-comment-help-handlers` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/03-command-handlers/sections/section-05-move-comment-help-handlers.md`
