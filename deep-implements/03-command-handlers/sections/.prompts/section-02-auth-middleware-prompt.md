...
Generate content for section `section-02-auth-middleware` (filename: `section-02-auth-middleware.md`).
...
for `section-02-auth-middleware` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/03-command-handlers/sections/section-02-auth-middleware.md`
