...
Generate content for section `section-03-utils` (filename: `section-03-utils.md`).
...
for `section-03-utils` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/03-command-handlers/sections/section-03-utils.md`
