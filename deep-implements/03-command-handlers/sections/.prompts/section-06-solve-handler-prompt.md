...
Generate content for section `section-06-solve-handler` (filename: `section-06-solve-handler.md`).
...
for `section-06-solve-handler` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/03-command-handlers/sections/section-06-solve-handler.md`
