...
Generate content for section `section-03-checksums-generation` (filename: `section-03-checksums-generation.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/04-distribution/claude-plan.md` - Full implementation plan
2. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/04-distribution/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/04-distribution/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-checksums-generation` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/04-distribution/sections/section-03-checksums-generation.md`
