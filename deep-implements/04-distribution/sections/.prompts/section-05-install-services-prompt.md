...
Generate content for section `section-05-install-services` (filename: `section-05-install-services.md`).
...
for `section-05-install-services` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/04-distribution/sections/section-05-install-services.md`
