...
Generate content for section `section-02-binary-targets` (filename: `section-02-binary-targets.md`).
...
for `section-02-binary-targets` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/04-distribution/sections/section-02-binary-targets.md`
