...
Generate content for section `section-04-install-core` (filename: `section-04-install-core.md`).
...
for `section-04-install-core` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/04-distribution/sections/section-04-install-core.md`
