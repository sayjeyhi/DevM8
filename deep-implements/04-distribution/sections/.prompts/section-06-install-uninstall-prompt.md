...
Generate content for section `section-06-install-uninstall` (filename: `section-06-install-uninstall.md`).
...
for `section-06-install-uninstall` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/04-distribution/sections/section-06-install-uninstall.md`
