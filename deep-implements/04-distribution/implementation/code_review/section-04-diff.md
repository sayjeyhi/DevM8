...
+    echo "Checksum mismatch — download may be corrupted. Delete $TMP_DIR and retry." >&2
+    exit 1
+  fi
+}
+
...
+    [ -n "$FAKE_HOME" ] && rm -rf "$FAKE_HOME"
 ...
 verify_binary_size() {
@@ -121,3 +125,216 @@ _make_fixture_checksums() {
