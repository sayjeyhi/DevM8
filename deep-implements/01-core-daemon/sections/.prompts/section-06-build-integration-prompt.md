...
Generate content for section `section-06-build-integration` (filename: `section-06-build-integration.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/01-core-daemon/claude-plan.md` - Full implementation plan
2. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/01-core-daemon/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/01-core-daemon/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-build-integration` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/01-core-daemon/sections/section-06-build-integration.md`
