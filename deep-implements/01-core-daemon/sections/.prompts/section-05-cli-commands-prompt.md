...
Generate content for section `section-05-cli-commands` (filename: `section-05-cli-commands.md`).
...
for `section-05-cli-commands` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/01-core-daemon/sections/section-05-cli-commands.md`
