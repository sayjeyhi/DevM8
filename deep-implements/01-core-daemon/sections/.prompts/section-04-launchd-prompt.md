...
Generate content for section `section-04-launchd` (filename: `section-04-launchd.md`).
...
for `section-04-launchd` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/01-core-daemon/sections/section-04-launchd.md`
