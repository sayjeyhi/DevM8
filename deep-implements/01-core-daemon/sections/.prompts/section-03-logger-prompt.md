...
Generate content for section `section-03-logger` (filename: `section-03-logger.md`).
...
for `section-03-logger` to understand what this section should contain.
...
`/Users/sayjeyhi/Desktop/projects/github/sayjeyhi/jira-assistant/01-core-daemon/sections/section-03-logger.md`
